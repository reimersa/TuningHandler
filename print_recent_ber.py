...
if __name__=='__main__':
    ...
    parser.add_argument('--db', dest='database', type=str, default='db/ber.json',
                        help='database file name to query')
    ...
    parser.add_argument('--list-named', dest='list_named', action='store_true',default=False, help="list the scans with names and show their indices")
